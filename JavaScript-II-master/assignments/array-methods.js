...
// let names = [];
// Object.values(runners).forEach(runner => {names.push(runner.first_name); 
//                                            names.push(runner.last_name)})
// console.log(names)
// ==== Challenge 2: Use .map() ==== 

// The event director needs to have all the runner's first names converted to uppercase because the director BECAME DRUNK WITH POWER. Convert each first name into all caps and log the result
// let allCaps = [];
// const allCaps = Object.values(runners).map(runner => runner.first_name.toUpperCase());
// console.log(allCaps); 
...
// Problem 1
//Sort runners in alphabetical order by last name
// const sortedRunners = runners.sort((a,b) => a.last_name.localeCompare(b.last_name));
// console.log(sortedRunners);
// // Problem 2
//Array of emails of the 15 runners who donated the most
let highRollers;
const donationSort = runners.sort((a,b) => a.donation - b.donation);
for(let i = 44; i < runners.length; i++){
    highRollers = Object.values(donationSort).map(runner => runner.email);
}
